...
function getRadio(){
    ...
    $.ajax({
        ...
        url:"https://wxzc.bjunicom.com.cn/queryCenter/web-pc/out-order/page/ifmGovUserUrge?userName="+userName+"&exCode="+exCode+"&callCode="+callCode,
        contentType: "application/json;charset=UTF-8",
        data:JSON.stringify({
            "balkno": orderNum ,
            "remark" : remark,
        ...
        success : function(resData) {
            ...
            var href=getOutUrl(getRootPath_web(),"/web-pc/out-order/page/flow-zqza-list.html?orderNum="+orderNum+"&secCode="+secCode);//故障处理详情
            console.log(desc);
            if(state == 200) {
                layer.open({
                    content: '催修成功'
