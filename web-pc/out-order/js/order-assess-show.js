	...
	var orderAssessObj = {
	    ...
	    initData: function(data) {
	        ...
	        if (extLevel5 != undefined && extLevel5) {
	            ...
	            star(extLevel5, '#PdoorService-star')
	                // q2-q3 q4回显
	            if (extLevel5 <= 6) {
	                // $('#q2').addClass('disBlock').removeClass('disNone').siblings('.servicePer').addClass('disNone').removeClass('disBlock')
