$(function () {
    $("#uls li").click(function () {
        ...
        $("#tableBoxCon > div").eq(index).show().siblings().hide();
            ...
            success: function (r) {
                if (r) {
                    ...
                    if (state && state != '1') {
                        ...
                        orderListObj.initTable(resultCallback, '#table11', 'phone');
                        orderListObj.initTable(resultCallback, '#table22', 'serial');
                        orderListObj.initTable(resultCallback, '#table33', 'trouble');
                    }
                }
