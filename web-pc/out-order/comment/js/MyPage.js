...
function Page() {
    ...
    this.pageHtml = function() {
        ...
        if (pageIndex <= 0 || pageIndex == 1) {
            ...
            pageHtml += '<li><a href="javascript:getPJList(1);" data-pageindex="1">首页</a></li>' +
                '<li><a href="javascript:getPJList(' + (pageIndex - 1) + ');" data-pageindex="' + (pageIndex - 1) + '">上一页</a></li>';
        }
        ...
        for (var i = k; i < (k + j); i++) {
            ...
            if (i == 0) {
                ...
                pageHtml += '<li><a href="javascript:getPJList(' + (pageIndex + i) + ');" data-pageindex="' + (pageIndex + i) + '">' + (pageIndex + i) + '</a></li>';
            }
        }
        ...
        if (pageTotal == 1 || pageTotal <= pageIndex) {
            ...
            pageHtml += '<li><a href="javascript:getPJList(' + (pageIndex + 1) + ');" data-pageindex="' + (pageIndex + 1) + '">下一页</a></li>' +
                '<li><a href="javascript:getPJList(' + pageTotal + ');" data-pageindex="' + pageTotal + '">末页</a></li>';
        }
        pageHtml += '</ul>'
        $(elemId).html('');
