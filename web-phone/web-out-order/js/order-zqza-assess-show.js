...
*/
//获取路径中参数
var balkNo = getUrlParam("qryNumber");//订单号
...
var orderAssessObj = {
    ...
    assessAjax: function() {
        ...
        $.ajax({
          ...
          /*  url: "https://wxzc.bjunicom.com.cn/queryCenter/ifm/ifmGovUserEvaluateGet?userName=oNj7k5BOTQzETEawNmT_jlfNaaI8&exCode=kbxcx&callCode=3ac4dd4f4798c2c562a830e9ee2d7a07",*/
            url: "https://wxzc.bjunicom.com.cn/queryCenter/web-phone/web-out-order/page/ifmGovUserEvaluateGet?userName="+userName+"&exCode="+exCode+"&callCode="+callCode,
   ...
   initData: function(data) {
       ...
       //上门服务
       if (v2 == undefined || checkNullOrEmptyStr(v2)){
           $("#fashion").hide();
       } else {
           $("#fashion").show();
           orderAssessObj.initFashionRaty(v2);
